	...
	return [
		<InspectorControls>
			<PanelBody title="Settings">
				...
				<ToggleControl
					label="Hide Pros/Cons"
					checked={hideProsCons}
					onChange={(val) => {
						setAttributes({ hideProsCons: val });
					}}
				/>
				<TextControl
					label="Button text"
		...
		<ServerSideRender
			block="affreviews/grid"
			attributes={attributes}
			EmptyResponsePlaceholder={() => (
				<Placeholder icon={info} label={__("Reviews Grid Info", "affreviews")}>
					<div
